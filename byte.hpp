...
#define GETVAR_LE32(p)                                                                                       \
    ({                                                                                                       \
        u32 r = (( u32 )(p)[0] << 0) | (( u32 )(p)[1] << 8) | (( u32 )(p)[2] << 16) | (( u32 )(p)[3] << 24); \
        p += 4;                                                                                              \
        r;                                                                                                   \
    })
...
#define GETVAR_LE64(p)                                                                                           \
    ({                                                                                                           \
        u64 r = (( u64 )(p)[0] << 0) | (( u64 )(p)[1] << 8) | (( u64 )(p)[2] << 16) | (( u64 )(p)[3] << 24)      \
...
#define GETVAR_BE32(p)                                                                                       \
    ({                                                                                                       \
        u32 r = (( u32 )(p)[0] << 24) | (( u32 )(p)[1] << 16) | (( u32 )(p)[2] << 8) | (( u32 )(p)[3] << 0); \
        p += 4;                                                                                              \
        r                                                                                                    \
    })
...
#define GETAVR_BE64(p)                                                                                              \
    ({                                                                                                              \
        u64 r = (( u64 )(( u8 )(p)[0]) << 56) | (( u64 )(( u8 )(p)[1]) << 48) | (( u64 )(( u8 )(p)[2]) << 40)       \
                | (( u64 )(( u8 )(p)[3]) << 32) | (( u8 )(p)[4] << 24) | (( u8 )(p)[5] << 16) | (( u8 )(p)[6] << 8) \
                | (( u8 )(p)[7] << 0);                                                                              \
        p += 8;                                                                                                     \
        r;                                                                                                          \
    })